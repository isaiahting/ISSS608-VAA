...
In this section, you will learn how to plot a calendar heatmap programmatically by using ggplot2 package.
...
ggplot() +
  ...
  labs(axis.text.x = element_blank(),
      title = "Visitors Arrival from Vietnam via Air, Jan 2010 - Dec 2019") +
  xlab("") +
  ylab("No. of Visitors") +
  theme_tufte(base_family = "Helvetica")
```
